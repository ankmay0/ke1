...
// SPA (React Router): clean client-side routes. Hashes are kept absolute
// (`/#quote`) so a link works from any page — react-router navigates home and
...
export const HERO_STATS = [
  { num: '13', sup: '+', label: 'Years of execution' },
...
export const ABOUT_CALLOUTS = [
  ...
  {
    n: '03',
    text: 'Experienced in Maccaferri Geosynthetic Solutions',
    detail:
      'Experienced in the application and installation of geosynthetic solutions, including gabions, geogrids and reinforced soil systems, using Maccaferri materials for slope protection, retaining structures and ground stabilisation.',
  },
]

export const CAPABILITY_TAGS = [
  'RDSO Standards', '13+ Years Experience', '230+ Workforce', 'Modern Machinery',
]

// Mission & Vision — the purpose statements carried over from the company
// profile. `quote` is split into pre / em / post so the accent fragment can be
// highlighted; `pillars` render as a terse footnote row on each card.
export const MISSION = {
  label: 'Mission',
  n: '/01',
  quote: {
    pre: 'Deliver ',
    em: 'sustainable and innovative',
    post: ' infrastructure solutions that enhance connectivity, mobility, and economic growth while maintaining the highest standards of safety and environmental responsibility.',
  },
  pillars: [
    'Sustainable & innovative execution',
    'Connectivity, mobility, economic growth',
...
export const VISION = {
  ...
  quote: {
    pre: 'To become the ',
    em: 'most trusted',
    post: ' infrastructure partner, setting benchmarks in excellence, sustainability, and transport development across India.',
  },
  pillars: [
    'Benchmarks in excellence',
    'Sustainability at scale',
    'Transport development across India',
  ],
}
...
export const PROJECTS = [
  {
    cat: 'Railway', title: 'KARO Railway Siding Infrastructure Project – CCL',
  ...
  {
    cat: 'Geotechnical', title: 'Railway Slope Protection & Geotechnical Infrastructure Project – East Central Railway',
  ...
  {
    cat: 'Railway', title: 'Railway Formation & Bridge Infrastructure Project – Tori–Shivpur Rail Line',
  ...
  {
    cat: 'Railway', title: 'Barh STPP RoR Line Strengthening Project – NTPC',
  ...
  {
    cat: 'Civil', title: 'KARO Building Civil & Architectural Project – Parasa Substation',
...
export const STATS = [
  ...
  { num: '13', sup: '+', label: 'Years of industry expertise' },
]
...
export const CLIENTS = [
  { abbr: 'RWD', full: 'Rural Works Department', logo: '/assets/client-jharkhand.png' },
  { abbr: 'IPRCL', full: 'Indian Port Rail Corporation Ltd.', logo: '/assets/client-iprcl.png' },
  { abbr: 'RCD', full: 'Road Construction Department', logo: '/assets/client-jharkhand.png' },
  { abbr: 'ECR', full: 'East Central Railway', logo: '/assets/client-ecr.png' },
  { abbr: 'TVNL', full: 'Tenughat Vidyut Nigam Ltd.', logo: '/assets/client-tvnl.png' },
  { abbr: 'RVNL', full: 'Rail Vikas Nigam Ltd.', logo: '/assets/client-rvnl.png' },
  { abbr: 'GTFL', full: 'Garware Technical Fibres Ltd.', logo: '/assets/client-garware.png' },
  { abbr: 'AES', full: 'Asian Energy Services Ltd.', logo: '/assets/client-aes.png' },
]

export const TESTIMONIALS = [
  {
    quote: 'Their team coordinated block-time operations flawlessly across the Tori Shivpur siding stretch — zero incidents, ahead of schedule.',
    name: 'Hansraj Meena',
